...
<form method="POST" action="?/createProduct" enctype="multipart/form-data" class="bg-white rounded-lg shadow-md p-6 max-w-lg mx-auto space-y-4">
    ...
    <div class="space-y-2">
		...
		<select name="categoryId" id="categoryId" class="w-full px-3 py-2 border rounded-md focus:ring-2 focus:ring-blue-500 focus:outline-none">
	...
	<div class="space-y-2">
		...
		<textarea name="price" id="price" placeholder="Enter price"  class="w-full px-3 py-2 border rounded-md focus:ring-2 focus:ring-blue-500 focus:outline-none h-24"></textarea>
	</div>

	<div class="space-y-2">
		<label for="image" class="block text-sm font-medium text-gray-700">Image</label>
		<input type="file" name="uploadedImage" class="w-full border border-gray-300 p-2 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400">
